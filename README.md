...
![Google Gemini](https://img.shields.io/badge/Google%20Gemini-IA-4285F4?style=flat-square&logo=googlegemini&logoColor=white)
...
| | |
|---|---|
| ☕ **Backend** | Java 21 · Spring Boot 4.1.1 (Web, Data JPA, Security, Validation, Lombok) · JWT (jjwt) · springdoc-openapi (Swagger UI) · Maven Wrapper |
| 🅰️ **Frontend** | Angular 18 (standalone, routing) · TypeScript · SCSS · Angular Material |
| 🐘 **Base de datos** | PostgreSQL + extensión `pgvector` (RAG del agente de IA), vía Docker Compose |
...
|---|---|---|---|
| ![ADMIN](https://img.shields.io/badge/ADMIN-E63946?style=flat-square) | Admin Nemblex | `admin@nemblex.dev` | `admin123` |
| ![SUPERVISOR](https://img.shields.io/badge/SUPERVISOR-457B9D?style=flat-square) | Beatriz Ruiz | `beatriz.ruiz@nemblex.dev` | `supervisor123` |
| ![TECHNICIAN](https://img.shields.io/badge/TECHNICIAN-2A9D8F?style=flat-square) | Ana Torres | `ana.torres@nemblex.dev` | `technician123` |
| ![EMPLOYEE](https://img.shields.io/badge/EMPLOYEE-8D99AE?style=flat-square) | Carlos Mendez | `carlos.mendez@nemblex.dev` | `employee123` |
| ![EMPLOYEE](https://img.shields.io/badge/EMPLOYEE-8D99AE?style=flat-square) | Lucia Camara | `lucia.camara@nemblex.dev` | `employee123` |
| ![EMPLOYEE](https://img.shields.io/badge/EMPLOYEE-8D99AE?style=flat-square) | Javier Ferrer | `javier.ferrer@nemblex.dev` | `employee123` |
| ![EMPLOYEE](https://img.shields.io/badge/EMPLOYEE-8D99AE?style=flat-square) | Paula Nogales | `paula.nogales@nemblex.dev` | `employee123` |
| ![EMPLOYEE](https://img.shields.io/badge/EMPLOYEE-8D99AE?style=flat-square) | Sofia Duarte | `sofia.duarte@nemblex.dev` | `employee123` |
| ![EMPLOYEE](https://img.shields.io/badge/EMPLOYEE-8D99AE?style=flat-square) | Ricardo Olmos | `ricardo.olmos@nemblex.dev` | `employee123` |

> ⚠️ Credenciales solo para entorno de desarrollo local. El seed nunca se ejecuta fuera del perfil `dev`.
